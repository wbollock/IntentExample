...
public class Apples extends AppCompatActivity {
    ...
    public void onClick(View view){
        Intent i = new Intent(this, Bacon.class); // bacon is activity we want to launch "onClick"

        final EditText applesInput = (EditText) findViewById(R.id.applesInput);
        String userMessage = applesInput.getText().toString(); // get the text and store is a string in usermessage
